...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-app-bg-deep text-app-text-primary flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        <div className="text-7xl font-bold bg-gradient-to-br from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-2">
          404
        </div>
        <div className="w-14 h-14 mx-auto mb-4 bg-app-bg-card border border-app-border-base rounded-2xl flex items-center justify-center">
          <FileX className="w-7 h-7 text-app-text-secondary" />
        </div>
        <h1 className="text-xl font-bold mb-2">页面未找到</h1>
        <p className="text-app-text-secondary text-sm mb-6">您访问的页面不存在或已被移除。</p>
