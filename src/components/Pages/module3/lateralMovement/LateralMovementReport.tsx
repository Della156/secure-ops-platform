...
type ReportType = 'daily' | 'weekly' | 'monthly' | 'special' | 'replay';
...
const REPORTS: Report[] = [
  { id: 'LMR-2026-0901', title: '2026-06-04 横向渗透监测日报', type: 'daily', status: 'pushed', period: '2026-06-04', generateTime: '2026-06-04 23:00:00', tasks: 8, pathsFound: 4, size: 384, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }, { channel: 'dingtalk', status: 'success', recipients: 15 }], author: '系统自动', pages: 16 },
  { id: 'LMR-2026-0900', title: '2026-06-03 横向渗透监测日报', type: 'daily', status: 'pushed', period: '2026-06-03', generateTime: '2026-06-03 23:00:00', tasks: 15, pathsFound: 12, size: 512, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }, { channel: 'dingtalk', status: 'success', recipients: 15 }], author: '系统自动', pages: 22 },
  { id: 'LMR-2026-0902', title: '2026-W22 周横向渗透监测周报', type: 'weekly', status: 'pushed', period: '2026-05-25 ~ 2026-05-31', generateTime: '2026-06-01 09:00:00', tasks: 78, pathsFound: 45, size: 1280, channels: ['email', 'dingtalk', 'wechat'], pushStatus: [{ channel: 'email', status: 'success', recipients: 35 }, { channel: 'dingtalk', status: 'success', recipients: 18 }, { channel: 'wechat', status: 'success', recipients: 12 }], author: '系统自动', pages: 38 },
  { id: 'LMR-2026-0903', title: '2026-05 月横向渗透月报', type: 'monthly', status: 'pushed', period: '2026-05-01 ~ 2026-05-31', generateTime: '2026-06-01 11:00:00', tasks: 325, pathsFound: 188, size: 3072, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 42 }, { channel: 'dingtalk', status: 'success', recipients: 22 }], author: '安全-张工', pages: 68 },
  { id: 'LMR-2026-0904', title: 'APT-29 攻击路径复现专项报告', type: 'replay', status: 'pushed', period: '2026-06-02', generateTime: '2026-06-02 18:00:00', tasks: 1, pathsFound: 7, size: 1024, channels: ['email', 'dingtalk', 'sms'], pushStatus: [{ channel: 'email', status: 'success', recipients: 12 }, { channel: 'dingtalk', status: 'success', recipients: 8 }], author: 'CISO', pages: 24 },
  { id: 'LMR-2026-0905', title: '凭据滥用专项分析报告', type: 'special', status: 'generated', period: '2026-Q2', generateTime: '2026-06-04 14:00:00', tasks: 28, pathsFound: 18, size: 768, channels: ['email'], pushStatus: [{ channel: 'email', status: 'pending', recipients: 18 }], author: '安全-陈工', pages: 28 },
  { id: 'LMR-2026-0906', title: 'SMB 异常连接专项报告', type: 'special', status: 'draft', period: '2026-06', generateTime: '2026-06-04 16:00:00', tasks: 12, pathsFound: 5, size: 512, channels: ['email'], pushStatus: [], author: '运维-李工', pages: 18 },
  { id: 'LMR-2026-0907', title: '2026-06-02 横向渗透监测日报', type: 'daily', status: 'archived', period: '2026-06-02', generateTime: '2026-06-02 23:00:00', tasks: 14, pathsFound: 8, size: 432, channels: ['email'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }], author: '系统自动', pages: 18 },
];
...
const TYPE_MAP: Record<ReportType, { label: string; color: string; bg: string }> = {
  ...
  replay: { label: '复现', color: 'text-red-400', bg: 'bg-red-500/20' },
};
...
const COLUMNS = [
  ...
  { key: 'paths', title: '路径', width: '60px', render: (r: Report) => <span className={`text-xs font-medium ${r.pathsFound > 0 ? 'text-red-400' : 'text-slate-500'}`}>{r.pathsFound}</span> },
 ...
 */
export function LateralMovementReport() {
  ...
  const typePie = useMemo(() => {
    const counts: Record<string, number> = { daily: 0, weekly: 0, monthly: 0, special: 0, replay: 0 };
  ...
  const monthlyTrend = [
    { month: '1月', reports: 28, paths: 156 },
    { month: '2月', reports: 25, paths: 142 },
    { month: '3月', reports: 31, paths: 188 },
    { month: '4月', reports: 30, paths: 172 },
    { month: '5月', reports: 35, paths: 218 },
    { month: '6月', reports: 8, paths: 56 },
  ];
        ...
        <Card>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={monthlyTrend}>
              ...
              <Bar dataKey="paths" fill="#EF4444" name="发现路径" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </Card>
      </div>
...
export default LateralMovementReport;
