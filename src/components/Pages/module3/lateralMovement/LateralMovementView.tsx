...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'LM-001', name:'核心网横向渗透监测', status:'running', alertTotal:156, sourceCount:5, attackPath:'3级跳板', startTime:'2026-06-02 08:00' },
  { id:'LM-002', name:'办公网横向渗透监测', status:'completed', alertTotal:89, sourceCount:3, attackPath:'2级跳板', startTime:'2026-06-01 08:00' },
  { id:'LM-003', name:'数据中心横向渗透监测', status:'running', alertTotal:234, sourceCount:7, attackPath:'4级跳板', startTime:'2026-06-02 10:00' },
  { id:'LM-004', name:'云平台横向渗透监测', status:'failed', alertTotal:12, sourceCount:2, attackPath:'1级跳板', startTime:'2026-06-02 06:00' },
  { id:'LM-005', name:'物联网横向渗透监测', status:'pending', alertTotal:0, sourceCount:0, attackPath:'-', startTime:'2026-06-03 00:00' }
];
...
export function LateralMovementView() {
  ...
  return (
    <div>
      <PageHeader title="横向渗透监测视图" description="监控和分析横向渗透攻击行为，集成多源数据，实时推送告警"
        actions={[
  ...
  { key:'alertTotal', title:'告警总数', sortable:true },
  { key:'sourceCount', title:'数据源数' },
  { key:'attackPath', title:'攻击链' },
