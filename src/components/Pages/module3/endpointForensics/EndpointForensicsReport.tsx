...
const mockData = [
{ id:'TR-001', name:'终端取证', status:'completed', reportName:'终端取证 执行报告_v1', createTime:'2026-06-02 08:00', downloadCount:5 },
  { id:'TR-002', name:'终端取证', status:'completed', reportName:'终端取证 执行报告_v2', createTime:'2026-06-02 09:00', downloadCount:3 },
  { id:'TR-003', name:'终端取证', status:'running', reportName:'终端取证 执行报告_v3（生成中）', createTime:'2026-06-02 10:00', downloadCount:0 }
];
...
export function EndpointForensicsReport() {
  return (
    <StandardSubPage
      title="终端取证任务报告"
      description="查看任务的执行报告 - 终端取证任务报告"
      mockData={mockData}
