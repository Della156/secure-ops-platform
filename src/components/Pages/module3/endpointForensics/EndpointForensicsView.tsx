...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'EF-001', name:'核心网络终端取证', status:'running', totalTasks:8, analyzing:3, completed:4, failed:1 },
  { id:'EF-002', name:'办公网络终端取证', status:'completed', totalTasks:5, analyzing:0, completed:5, failed:0 },
  { id:'EF-003', name:'数据中心终端取证', status:'running', totalTasks:6, analyzing:2, completed:3, failed:1 },
  { id:'EF-004', name:'分支机构终端取证', status:'failed', totalTasks:4, analyzing:1, completed:1, failed:2 }
];
...
export function EndpointForensicsView() {
  ...
  return (
    <div>
      <PageHeader title="终端取证视图" description="自动化终端取证，获取异常样本和日志信息"
        actions={[
