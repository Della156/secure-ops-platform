...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'IP-001', name:'边界入侵检测', status:'running', attackCount:345, intentLevel:'严重', protectType:'IPS', monitorTime:'2026-06-02 08:00' },
  { id:'IP-002', name:'DDoS攻击监测', status:'completed', attackCount:1289, intentLevel:'高危', protectType:'Anti-DDoS', monitorTime:'2026-06-01 08:00' },
  { id:'IP-003', name:'Web应用防护', status:'running', attackCount:567, intentLevel:'中危', protectType:'WAF', monitorTime:'2026-06-02 10:00' },
  { id:'IP-004', name:'邮件安全网关', status:'failed', attackCount:89, intentLevel:'低危', protectType:'邮件过滤', monitorTime:'2026-06-02 06:00' },
  { id:'IP-005', name:'DNS安全监测', status:'running', attackCount:234, intentLevel:'高危', protectType:'DNS安全', monitorTime:'2026-06-02 14:00' }
];
...
export function InternetProtectionView() {
  ...
  return (
    <div>
      <PageHeader title="互联网防护监测视图" description="互联网边界安全防护监测，攻击意图预测"
        actions={[
  ...
  { key:'attackCount', title:'攻击次数', sortable:true },
  { key:'intentLevel', title:'威胁等级', render:(v) => <StatusBadge status={v==='严重'||v==='高危'?'warning':'info'} /> },
  { key:'protectType', title:'防护类型' },
  { key:'monitorTime', title:'监测时间' },
