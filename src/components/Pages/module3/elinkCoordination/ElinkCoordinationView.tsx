...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'EC-001', name:'态势感知平台联动', status:'running', targetSystem:'安全大脑', syncStatus:'同步中', alertCount:256, lastSyncTime:'2026-06-02 08:00' },
  { id:'EC-002', name:'SOC平台联动', status:'completed', targetSystem:'SIEM', syncStatus:'已同步', alertCount:1289, lastSyncTime:'2026-06-01 08:00' },
  { id:'EC-003', name:'NDR平台联动', status:'running', targetSystem:'流量分析', syncStatus:'同步中', alertCount:567, lastSyncTime:'2026-06-02 10:00' },
  { id:'EC-004', name:'EDR平台联动', status:'failed', targetSystem:'终端检测', syncStatus:'同步失败', alertCount:89, lastSyncTime:'2026-06-02 06:00' }
];
...
/* --- Main Component --- */
export function ElinkCoordinationView() {
  ...
  return (
    <div>
      <PageHeader title="ELINK协同联动视图" description="跨系统协同联动配置与告警信息推送"
        actions={[
  ...
  { key:'targetSystem', title:'目标系统' },
  { key:'syncStatus', title:'同步状态', render:(v) => <StatusBadge status={v==='已同步'?'completed':v==='同步中'?'running':'failed'} /> },
  { key:'alertCount', title:'告警数', sortable:true },
  { key:'lastSyncTime', title:'最后同步' },
