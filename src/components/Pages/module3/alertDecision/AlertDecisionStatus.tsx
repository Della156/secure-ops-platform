...
const mockData = [
{ id:'TS-001', name:'告警决策-核心网络', status:'running', progress:75, duration:'00:45:30' },
  { id:'TS-002', name:'告警决策-办公网络', status:'completed', progress:100, duration:'02:15:00' },
  { id:'TS-003', name:'告警决策-数据中心', status:'failed', progress:30, duration:'00:12:00' },
  { id:'TS-004', name:'告警决策-分支机构', status:'pending', progress:0, duration:'-' },
  { id:'TS-005', name:'告警决策-云平台', status:'running', progress:60, duration:'01:30:00' }
];
...
export function AlertDecisionStatus() {
  return (
    <StandardSubPage
      title="告警决策任务状态监控"
      description="实时监控任务的运行状态 - 告警决策任务状态监控"
      mockData={mockData}
