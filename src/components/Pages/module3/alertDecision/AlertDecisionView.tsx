...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'AD-001', name:'入侵告警自动决策', status:'running', alertSource:'IDS/IPS', riskLevel:'高危', autoDecision:'自动阻断', processTime:'2026-06-02 08:00' },
  { id:'AD-002', name:'异常流量告警决策', status:'completed', alertSource:'流量分析', riskLevel:'中危', autoDecision:'限速', processTime:'2026-06-01 08:00' },
  { id:'AD-003', name:'恶意软件告警决策', status:'running', alertSource:'终端检测', riskLevel:'严重', autoDecision:'隔离', processTime:'2026-06-02 10:00' },
  { id:'AD-004', name:'Web攻击告警决策', status:'failed', alertSource:'WAF', riskLevel:'低危', autoDecision:'放行', processTime:'2026-06-02 06:00' },
  { id:'AD-005', name:'数据泄露告警决策', status:'running', alertSource:'DLP', riskLevel:'高危', autoDecision:'审批阻断', processTime:'2026-06-02 14:00' }
];
...
export function AlertDecisionView() {
  ...
  return (
    <div>
      <PageHeader title="告警分析决策视图" description="多源告警自动化集成、快速筛查与智能决策分析"
        actions={[
  ...
  { key:'alertSource', title:'告警源' },
  { key:'riskLevel', title:'风险等级', render:(v) => <StatusBadge status={v==='严重'||v==='高危'?'warning':v==='中危'?'info':'success'} /> },
  { key:'autoDecision', title:'自动决策' },
  { key:'processTime', title:'处置时间' },
