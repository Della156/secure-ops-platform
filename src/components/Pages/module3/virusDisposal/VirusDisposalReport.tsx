...
const mockData = [
{ id:'TR-001', name:'病毒处置', status:'completed', reportName:'病毒处置 执行报告_v1', createTime:'2026-06-02 08:00', downloadCount:5 },
  { id:'TR-002', name:'病毒处置', status:'completed', reportName:'病毒处置 执行报告_v2', createTime:'2026-06-02 09:00', downloadCount:3 },
  { id:'TR-003', name:'病毒处置', status:'running', reportName:'病毒处置 执行报告_v3（生成中）', createTime:'2026-06-02 10:00', downloadCount:0 }
];
...
export function VirusDisposalReport() {
  return (
    <StandardSubPage
      title="病毒处置任务报告"
      description="查看任务的执行报告 - 病毒处置任务报告"
      mockData={mockData}
