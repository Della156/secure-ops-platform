...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'VD-001', name:'勒索病毒专项处置', status:'running', virusCount:23, threatLevel:'严重', disposalRate:87, detectTime:'2026-06-02 08:00' },
  { id:'VD-002', name:'蠕虫病毒批量处置', status:'completed', virusCount:156, threatLevel:'高危', disposalRate:95, detectTime:'2026-06-01 08:00' },
  { id:'VD-003', name:'木马病毒处置', status:'running', virusCount:45, threatLevel:'中危', disposalRate:76, detectTime:'2026-06-02 10:00' },
  { id:'VD-004', name:'挖矿病毒处置', status:'failed', virusCount:12, threatLevel:'高危', disposalRate:45, detectTime:'2026-06-02 06:00' }
];
...
export function VirusDisposalView() {
  ...
  return (
    <div>
      <PageHeader title="病毒处置视图" description="自动化病毒识别、分析与处置"
        actions={[
  ...
  { key:'virusCount', title:'病毒数', sortable:true },
  { key:'threatLevel', title:'威胁等级', render:(v) => <StatusBadge status={v==='严重'?'error':v==='高危'?'warning':'info'} /> },
  { key:'disposalRate', title:'处置率', render:(v) => <span className='text-green-400'>{v}%</span> },
