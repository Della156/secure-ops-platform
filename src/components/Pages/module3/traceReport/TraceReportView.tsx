...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'TR-001', name:'APT攻击溯源报告', status:'completed', reportCount:5, reportType:'详细报告', pushStatus:'已推送', generateTime:'2026-06-01 08:00' },
  { id:'TR-002', name:'勒索病毒溯源报告', status:'running', reportCount:3, reportType:'简要报告', pushStatus:'生成中', generateTime:'2026-06-02 08:00' },
  { id:'TR-003', name:'数据泄露溯源报告', status:'pending', reportCount:0, reportType:'详细报告', pushStatus:'待生成', generateTime:'2026-06-03 00:00' },
  { id:'TR-004', name:'横向渗透溯源报告', status:'failed', reportCount:2, reportType:'简要报告', pushStatus:'生成失败', generateTime:'2026-06-02 06:00' }
];
...
export function TraceReportView() {
  ...
  return (
    <div>
      <PageHeader title="溯源报告视图" description="溯源报告自动生成与推送"
        actions={[
  ...
  { key:'reportCount', title:'报告数', sortable:true },
  { key:'reportType', title:'报告类型' },
  { key:'pushStatus', title:'推送状态', render:(v) => <StatusBadge status={v==='已推送'?'completed':v==='生成中'?'running':'failed'} /> },
