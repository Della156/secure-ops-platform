...
const mockData = [
{ id:'TR-001', name:'溯源报告', status:'completed', reportName:'溯源报告 执行报告_v1', createTime:'2026-06-02 08:00', downloadCount:5 },
  { id:'TR-002', name:'溯源报告', status:'completed', reportName:'溯源报告 执行报告_v2', createTime:'2026-06-02 09:00', downloadCount:3 },
  { id:'TR-003', name:'溯源报告', status:'running', reportName:'溯源报告 执行报告_v3（生成中）', createTime:'2026-06-02 10:00', downloadCount:0 }
];
...
export function TraceReportReport() {
  return (
    <StandardSubPage
      title="溯源报告任务报告"
      description="查看任务的执行报告 - 溯源报告任务报告"
      mockData={mockData}
