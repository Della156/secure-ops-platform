...
const tasks: ForensicsTask[] = [
  { id: 'HFOR-001', name: '主机安全取证', target: 'HOST-001', status: 'completed', startTime: '2026-06-03 09:00:00', progress: 100, dataCount: 15, logCount: 320 },
  { id: 'HFOR-002', name: '入侵分析取证', target: 'HOST-005', status: 'in_progress', startTime: '2026-06-03 10:00:00', progress: 70, dataCount: 8, logCount: 156 },
  { id: 'HFOR-003', name: '数据泄露调查', target: 'HOST-008', status: 'completed', startTime: '2026-06-03 08:30:00', progress: 100, dataCount: 22, logCount: 450 },
  { id: 'HFOR-004', name: '恶意软件追踪', target: 'HOST-012', status: 'pending', startTime: '2026-06-03 14:00:00', progress: 0, dataCount: 0, logCount: 0 },
];

const stats = [
  { label: '总取证任务', value: 18, icon: <PlayCircle className="w-4 h-4" />, color: '#0066FF' },
  { label: '取证中', value: 2, icon: <Clock className="w-4 h-4" />, color: '#F59E0B' },
  { label: '已完成', value: 15, icon: <CheckCircle2 className="w-4 h-4" />, color: '#22C55E' },
  { label: '失败', value: 1, icon: <XCircle className="w-4 h-4" />, color: '#EF4444' },
];
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="bg-[#20293F] border border-[#2A354D] rounded-lg p-4">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
          <div>
            <h3 className="text-sm font-semibold text-white">主机取证视图</h3>
            <p className="text-xs text-slate-500 mt-1">管理和监控主机取证任务</p>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              type="text" placeholder="搜索任务名称或目标主机..."
          ...
          <table className="w-full">
            <thead className="bg-[#111625]">
              <tr>
                ...
                <th className="px-4 py-2 text-left text-xs text-slate-400 font-medium">目标主机</th>
                ...
                <th className="px-4 py-2 text-left text-xs text-slate-400 font-medium">数据项数</th>
              ...
              {filteredTasks.map(task => {
                ...
                return (
                  <tr key={task.id} className="border-b border-[#2A354D] hover:bg-[#111625]/50">
                    ...
                    <td className="px-4 py-3 text-xs text-slate-300">{task.dataCount}</td>
...
export default HostForensicsView;
