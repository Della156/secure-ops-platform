...
import { Download, FileText, Activity, Calendar, Send, BarChart3, Mail, MessageSquare, Globe, Smartphone } from 'lucide-react';
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, AreaChart, Area, Line, PieChart, Pie, Cell, Legend } from 'recharts';

type ReportType = 'daily' | 'weekly' | 'monthly' | 'special' | 'ueba';
...
const REPORTS: Report[] = [
  { id: 'ABR-2026-1001', title: '2026-06-04 异常行为监测日报', type: 'daily', status: 'pushed', period: '2026-06-04', generateTime: '2026-06-04 23:00:00', tasks: 8, anomalies: 17, size: 384, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }, { channel: 'dingtalk', status: 'success', recipients: 15 }], author: '系统自动', pages: 16 },
  { id: 'ABR-2026-1000', title: '2026-06-03 异常行为监测日报', type: 'daily', status: 'pushed', period: '2026-06-03', generateTime: '2026-06-03 23:00:00', tasks: 18, anomalies: 38, size: 512, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }, { channel: 'dingtalk', status: 'success', recipients: 15 }], author: '系统自动', pages: 22 },
  { id: 'ABR-2026-1002', title: '2026-W22 周异常行为周报', type: 'weekly', status: 'pushed', period: '2026-05-25 ~ 2026-05-31', generateTime: '2026-06-01 09:00:00', tasks: 105, anomalies: 218, size: 1280, channels: ['email', 'dingtalk', 'wechat'], pushStatus: [{ channel: 'email', status: 'success', recipients: 35 }, { channel: 'dingtalk', status: 'success', recipients: 18 }, { channel: 'wechat', status: 'success', recipients: 12 }], author: '系统自动', pages: 38 },
  { id: 'ABR-2026-1003', title: '2026-05 月异常行为月报', type: 'monthly', status: 'pushed', period: '2026-05-01 ~ 2026-05-31', generateTime: '2026-06-01 11:00:00', tasks: 425, anomalies: 856, size: 3072, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 42 }, { channel: 'dingtalk', status: 'success', recipients: 22 }], author: '安全-张工', pages: 68 },
  { id: 'ABR-2026-1004', title: '用户实体行为分析 (UEBA) 季度报告', type: 'ueba', status: 'pushed', period: '2026-Q2', generateTime: '2026-06-04 14:00:00', tasks: 168, anomalies: 412, size: 2048, channels: ['email', 'dingtalk'], pushStatus: [{ channel: 'email', status: 'success', recipients: 22 }, { channel: 'dingtalk', status: 'success', recipients: 12 }], author: '安全-陈工', pages: 48 },
  { id: 'ABR-2026-1005', title: '数据外泄专项分析报告', type: 'special', status: 'generated', period: '2026-Q2', generateTime: '2026-06-04 16:00:00', tasks: 28, anomalies: 18, size: 768, channels: ['email'], pushStatus: [{ channel: 'email', status: 'pending', recipients: 18 }], author: '安全-陈工', pages: 28 },
  { id: 'ABR-2026-1006', title: '特权账号专项审计报告', type: 'special', status: 'draft', period: '2026-06', generateTime: '2026-06-04 17:00:00', tasks: 12, anomalies: 5, size: 512, channels: ['email'], pushStatus: [], author: '运维-李工', pages: 18 },
  { id: 'ABR-2026-1007', title: '2026-06-02 异常行为监测日报', type: 'daily', status: 'archived', period: '2026-06-02', generateTime: '2026-06-02 23:00:00', tasks: 16, anomalies: 42, size: 432, channels: ['email'], pushStatus: [{ channel: 'email', status: 'success', recipients: 28 }], author: '系统自动', pages: 18 },
];
...
const TYPE_MAP: Record<ReportType, { label: string; color: string; bg: string }> = {
  ...
  ueba: { label: 'UEBA', color: 'text-red-400', bg: 'bg-red-500/20' },
};
...
const COLUMNS = [
  ...
  { key: 'anomalies', title: '异常', width: '70px', render: (r: Report) => <span className={`text-xs font-medium ${r.anomalies > 0 ? 'text-red-400' : 'text-slate-500'}`}>{r.anomalies}</span> },
 ...
 */
export function AnomalyBehaviorReport() {
  ...
  const typePie = useMemo(() => {
    const counts: Record<string, number> = { daily: 0, weekly: 0, monthly: 0, special: 0, ueba: 0 };
  ...
  const monthlyTrend = [
    { month: '1月', reports: 28, anomalies: 612 },
    { month: '2月', reports: 25, anomalies: 548 },
    { month: '3月', reports: 31, anomalies: 728 },
    { month: '4月', reports: 30, anomalies: 692 },
    { month: '5月', reports: 35, anomalies: 856 },
    { month: '6月', reports: 8, anomalies: 218 },
  ];
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-slate-400 mt-1 text-sm">5 类报告自动生成 · 5 推送渠道 · 月度 35+ 份</p>
        </div>
        ...
        <Card>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={monthlyTrend}>
              ...
              <Bar dataKey="anomalies" fill="#EF4444" name="异常数" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </Card>
      </div>
        ...
        renderDetail={(r) => (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Field label="异常数" value={`${r.anomalies} 个`} highlight={r.anomalies > 0} />
...
export default AnomalyBehaviorReport;
