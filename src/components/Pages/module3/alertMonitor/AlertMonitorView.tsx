...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'AM-001', name:'核心网告警监测', status:'running', alertCount:128, alertTypeDist:'入侵检测 45%', startTime:'2026-06-02 08:00' },
  { id:'AM-002', name:'办公网告警监测', status:'completed', alertCount:256, alertTypeDist:'异常流量 52%', startTime:'2026-06-01 08:00' },
  { id:'AM-003', name:'数据中心告警监测', status:'running', alertCount:89, alertTypeDist:'恶意软件 38%', startTime:'2026-06-02 10:00' },
  { id:'AM-004', name:'分支机构告警监测', status:'failed', alertCount:45, alertTypeDist:'入侵检测 30%', startTime:'2026-06-02 06:00' },
  { id:'AM-005', name:'云平台告警监测', status:'pending', alertCount:0, alertTypeDist:'-', startTime:'2026-06-03 00:00' },
  { id:'AM-006', name:'物联网告警监测', status:'running', alertCount:67, alertTypeDist:'异常流量 55%', startTime:'2026-06-02 14:00' }
];
...
export function AlertMonitorView() {
  ...
  return (
    <div>
      <PageHeader title="告警辅助监测视图" description="监控和管理告警辅助监测任务，查看告警采集、分析、评估和预测的全链路状态"
        actions={[
  ...
  { key:'alertCount', title:'告警总数', sortable:true },
  { key:'alertTypeDist', title:'告警类型', render:(v) => <span className='text-xs text-gray-400'>{v}</span> },
