...
const mockData = [
{ id:'TR-001', name:'告警日报', status:'completed', reportName:'告警日报 执行报告_v1', createTime:'2026-06-02 08:00', downloadCount:5 },
  { id:'TR-002', name:'告警日报', status:'completed', reportName:'告警日报 执行报告_v2', createTime:'2026-06-02 09:00', downloadCount:3 },
  { id:'TR-003', name:'告警日报', status:'running', reportName:'告警日报 执行报告_v3（生成中）', createTime:'2026-06-02 10:00', downloadCount:0 }
];
