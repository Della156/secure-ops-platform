...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'DR-001', name:'安全态势日报', status:'completed', totalAlerts:1289, reportDate:'2026-06-01', pushStatus:'已推送', generateTime:'2026-06-01 08:00' },
  { id:'DR-002', name:'告警统计分析日报', status:'running', totalAlerts:567, reportDate:'2026-06-02', pushStatus:'生成中', generateTime:'2026-06-02 08:00' },
  { id:'DR-003', name:'威胁情报日报', status:'pending', totalAlerts:0, reportDate:'2026-06-03', pushStatus:'待生成', generateTime:'2026-06-03 00:00' },
  { id:'DR-004', name:'合规检查日报', status:'completed', totalAlerts:234, reportDate:'2026-06-01', pushStatus:'已推送', generateTime:'2026-06-01 09:00' }
];
...
/* --- Main Component --- */
export function AlertDailyReportView() {
  ...
  return (
    <div>
      <PageHeader title="告警日报视图" description="告警日报自动生成与推送"
        actions={[
  ...
  { key:'totalAlerts', title:'告警总数', sortable:true },
  { key:'reportDate', title:'报告日期' },
  { key:'pushStatus', title:'推送状态', render:(v) => <StatusBadge status={v==='已推送'?'completed':v==='生成中'?'running':'pending'} /> },
  { key:'generateTime', title:'生成时间' },
