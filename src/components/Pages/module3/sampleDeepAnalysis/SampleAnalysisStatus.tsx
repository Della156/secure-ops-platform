...
const mockData = [
{ id:'TS-001', name:'样本分析-核心网络', status:'running', progress:75, duration:'00:45:30' },
  { id:'TS-002', name:'样本分析-办公网络', status:'completed', progress:100, duration:'02:15:00' },
  { id:'TS-003', name:'样本分析-数据中心', status:'failed', progress:30, duration:'00:12:00' },
  { id:'TS-004', name:'样本分析-分支机构', status:'pending', progress:0, duration:'-' },
  { id:'TS-005', name:'样本分析-云平台', status:'running', progress:60, duration:'01:30:00' }
];
...
export function SampleAnalysisStatus() {
  return (
    <StandardSubPage
      title="样本分析任务状态"
      description="实时监控任务的运行状态 - 样本分析任务状态"
      mockData={mockData}
