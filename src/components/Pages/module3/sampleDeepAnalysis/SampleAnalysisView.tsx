...
/* --- Mock Data --- */
const mockData: Item[] = [
{ id:'SA-001', name:'未知样本批量分析', status:'running', totalSamples:45, analyzing:12, completed:28, malicious:5 },
  { id:'SA-002', name:'可疑PE文件分析', status:'completed', totalSamples:23, analyzing:0, completed:23, malicious:18 },
  { id:'SA-003', name:'恶意文档深度分析', status:'running', totalSamples:34, analyzing:8, completed:20, malicious:6 },
  { id:'SA-004', name:'移动端样本分析', status:'failed', totalSamples:12, analyzing:2, completed:8, malicious:2 }
];
...
export function SampleAnalysisView() {
  ...
  return (
    <div>
      <PageHeader title="样本分析视图" description="多工具深度样本分析"
        actions={[
  ...
  { key:'totalSamples', title:'总样本', sortable:true },
  { key:'analyzing', title:'分析中' },
  { key:'completed', title:'已完成', sortable:true },
  { key:'malicious', title:'恶意', render:(v) => <span className='text-red-400'>{v}</span> },
