...
export function HostList() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-[#F3F4F6] mb-4">主机资源管理</h1>
        <p className="text-[#9CA3AF]">管理和监控企业服务器主机资源</p>
      </div>
          ...
          <div className="bg-[#20293F] border border-[#2A354D] rounded-xl overflow-hidden">
            <table className="w-full">
              <thead className="bg-[#181F32]/50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-[#9CA3AF] uppercase tracking-wider">主机名称</th>
              ...
              <tbody className="divide-y divide-[#2A354D]">
                {filteredHosts.map(host => (
                  <tr key={host.id} className="hover:bg-[#181F32]/30 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-[#F3F4F6]">{host.name}</div>
                      <div className="text-sm text-[#6B7280]">{host.description}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#D1D5DB] font-mono">{host.ip}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#D1D5DB]">{host.group}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#9CA3AF]">{host.createdAt}</td>
            ...
            {filteredHosts.length === 0 && (
              <div className="px-6 py-12 text-center">
                <p className="text-[#6B7280]">暂无符合条件的主机</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-[#20293F] border border-[#2A354D] rounded-xl w-full max-w-lg mx-4">
            <div className="flex items-center justify-between p-4 border-b border-[#2A354D]">
              <h3 className="text-lg font-semibold text-[#F3F4F6]">{editingItem ? '编辑主机' : '添加主机'}</h3>
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#D1D5DB] mb-1">主机名称</label>
