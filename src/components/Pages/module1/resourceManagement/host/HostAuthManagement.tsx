...
const mockPolicies: AuthPolicy[] = [
  { id: 'policy-1', name: 'Web服务器管理员访问', target: '生产Web服务器', type: 'role', status: 'active', validFrom: '2026-01-01', validUntil: '2026-12-31' },
  { id: 'policy-2', name: '数据库只读访问', target: '数据库服务器', type: 'user', status: 'active', validFrom: '2026-03-15', validUntil: '2026-09-15' },
  { id: 'policy-3', name: '备份服务器访问', target: '备份服务器', type: 'role', status: 'inactive', validFrom: '2026-02-01', validUntil: '2026-06-01' },
];

const mockRequests: AuthRequest[] = [
  { id: 'req-1', applicant: '张三', target: '生产Web服务器', reason: '需要进行应用部署', status: 'pending', requestTime: '2026-06-01 09:30:00' },
  { id: 'req-2', applicant: '李四', target: '数据库服务器', reason: '查询生产数据', status: 'approved', requestTime: '2026-05-31 14:20:00' },
  { id: 'req-3', applicant: '王五', target: '缓存服务器', reason: '调试缓存问题', status: 'rejected', requestTime: '2026-05-30 11:15:00' },
];

export function HostAuthManagement() {
