...
export function HostAccessLog() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">主机访问日志查询</h1>
        <p className="text-slate-400">查看和分析主机的访问操作记录</p>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-slate-800/50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">目标主机</th>
          ...
          <tbody className="divide-y divide-slate-800">
            {filteredLogs.map(log => (
              <tr key={log.id} className="hover:bg-slate-800/30 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-300">{log.targetHost}</td>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-lg mx-4">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-400 mb-1">目标主机</label>
                  <p className="text-white">{selectedLog.targetHost}</p>
                </div>
                <div>
