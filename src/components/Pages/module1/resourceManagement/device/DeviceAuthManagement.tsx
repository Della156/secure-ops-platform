...
export function DeviceAuthManagement() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-[#F3F4F6] mb-4">设备访问授权管理</h1>
        <p className="text-[#9CA3AF]">管理设备访问授权策略，处理授权申请</p>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-[#181F32]/50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-[#9CA3AF] uppercase tracking-wider">目标设备</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-[#20293F] border border-[#2A354D] rounded-xl w-full max-w-lg mx-4">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#D1D5DB] mb-1.5">目标设备</label>
                <select
