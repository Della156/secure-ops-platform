...
export function SystemApiView() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-[#F3F4F6] mb-4">系统可用API视图</h1>
        <p className="text-[#9CA3AF]">浏览和查看安全系统提供的API接口</p>
      </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className={`p-2 rounded-lg ${service.type === 'API' ? 'bg-[#0066FF]/20' : 'bg-[#6366F1]/20'}`}>
                  <Code className={`w-5 h-5 ${service.type === 'API' ? 'text-[#0066FF]' : 'text-[#6366F1]'}`} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <span className={`px-2.5 py-1 rounded-full text-xs font-medium border ${service.type === 'API' ? 'bg-[#0066FF]/20 text-[#0066FF] border-blue-500/30' : 'bg-[#6366F1]/20 text-[#6366F1] border-purple-500/30'}`}>
                  {service.type}
                </span>
