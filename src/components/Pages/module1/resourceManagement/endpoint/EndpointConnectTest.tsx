...
export function EndpointConnectTest() {
  ...
  const getProtocolBadge = (protocol: string) => {
    const styles = {
      ...
      vnc: 'bg-[#00BCD4]/20 text-[#00BCD4] border-cyan-500/30',
    };
    return (
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-[#F3F4F6] mb-4">终端连接与认证测试</h1>
          <p className="text-[#9CA3AF]">测试终端连接状态和管理连接凭证</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-[#20293F] border border-[#2A354D] rounded-xl p-6">
          ...
          <div className="text-[#6B7280] text-sm">终端正常连接</div>
        </div>
        <div className="bg-[#20293F] border border-[#2A354D] rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
              ...
              <div key={cred.id} className="bg-[#20293F] border border-[#2A354D] rounded-xl p-4">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <div className="text-[#9CA3AF] text-sm font-mono">{cred.endpoint}:{cred.port}</div>
                ...
                <div key={log.id} className="flex items-center gap-4 px-4 py-3 border-b border-[#2A354D] last:border-0 hover:bg-[#181F32]/50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-[#F3F4F6] text-sm font-medium">{log.endpoint}</span>
          ...
          <div className="bg-[#20293F] border border-[#2A354D] rounded-xl w-full max-w-lg mx-4">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#D1D5DB] mb-1">终端地址</label>
                  <input
