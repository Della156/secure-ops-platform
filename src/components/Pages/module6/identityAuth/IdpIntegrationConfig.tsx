...
import { Plus, Search, Edit2, Trash2, Save, Shield, ExternalLink, CheckCircle, Check } from 'lucide-react';
...
export function IdpIntegrationConfig() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal open={showModal} onClose={() => setShowModal(false)} title="新增认证配置">
        <div className="space-y-4">
          <div>
