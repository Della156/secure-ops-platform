...
const mockTasks: DiagTask[] = [
  { id: 'CD-001', name: '综合故障诊断-网络系统', target: '数据中心网络设备', status: 'running', result: '诊断中...', diagTime: '2026-06-02 10:30:00', duration: '00:05:32', assignee: '张三' },
  { id: 'CD-002', name: '综合故障诊断-服务器集群', target: '应用服务器集群', status: 'success', result: '已完成，发现2个潜在问题', diagTime: '2026-06-02 09:15:00', duration: '00:12:18', assignee: '李四' },
  { id: 'CD-003', name: '综合故障诊断-数据库系统', target: '主数据库集群', status: 'failed', result: '检测到异常，建议立即处理', diagTime: '2026-06-02 08:00:00', duration: '00:08:45', assignee: '王五' },
  { id: 'CD-004', name: '综合故障诊断-存储系统', target: 'SAN存储阵列', status: 'pending', result: '待诊断', diagTime: '-', duration: '-', assignee: '赵六' },
  { id: 'CD-005', name: '综合故障诊断-安全系统', target: '防火墙/IDS系统', status: 'abnormal', result: '发现可疑流量模式', diagTime: '2026-06-02 07:30:00', duration: '00:15:22', assignee: '钱七' },
];
...
export function CompDiagView() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">综合故障诊断视图</h2>
          ...
          <tbody className="divide-y divide-[#2A354D]">
            {filteredTasks.map((task, idx) => (
              <tr key={task.id} className="hover:bg-[#2A354D]/30">
                ...
                <td className="px-4 py-3 text-sm text-gray-400">{task.diagTime}</td>
