...
const complianceData = [
  { name: '防火墙', compliant: 95, nonCompliant: 5 },
  { name: 'IDS', compliant: 92, nonCompliant: 8 },
  { name: 'WAF', compliant: 78, nonCompliant: 22 },
  { name: 'VPN', compliant: 45, nonCompliant: 55 },
  { name: 'EDR', compliant: 82, nonCompliant: 18 },
];
...
const mockReportData: ReportItem[] = [
  { category: '账户策略', total: 10, pass: 7, fail: 3, passRate: 70 },
  { category: '访问控制', total: 15, pass: 14, fail: 1, passRate: 93 },
  { category: '服务端口', total: 8, pass: 6, fail: 2, passRate: 75 },
  { category: '日志审计', total: 6, pass: 5, fail: 1, passRate: 83 },
];

export function SecurityDeviceBaselineReport() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">安全设备基线检查报告</h2>
        <p className="text-sm text-gray-400 mt-1">安全设备安全基线检查的综合报告</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-[#1E2736] border border-[#2A354D] rounded-lg p-4">
          <h3 className="text-sm font-medium text-gray-300 mb-4">设备合规率分布</h3>
