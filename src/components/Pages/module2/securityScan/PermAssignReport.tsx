...
const taskData = [
  { date: '05-28', tasks: 25, success: 22, failure: 3 },
  { date: '05-29', tasks: 30, success: 28, failure: 2 },
  { date: '05-30', tasks: 15, success: 14, failure: 1 },
  { date: '05-31', tasks: 20, success: 19, failure: 1 },
  { date: '06-01', tasks: 28, success: 25, failure: 3 },
  { date: '06-02', tasks: 18, success: 17, failure: 1 },
];

export function PermAssignReport() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">权限分配操作报告</h2>
        <p className="text-sm text-gray-400 mt-1">时间段内权限分配任务统计分析、分配报告导出</p>
      </div>
      ...
      <div className="bg-[#1E2736] border border-[#2A354D] rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-300 mb-4">权限分配任务统计趋势</h3>
