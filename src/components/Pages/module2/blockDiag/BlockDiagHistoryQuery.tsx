...
const mockHistory: HistoryItem[] = [
  { id: 'BLOCK-DIAG-HIST-001', title: '异常阻断流量诊断', target: 'Web 服务集群', result: 'success', diagTime: '2026-06-01 10:30:00', reportUrl: '#' },
  { id: 'BLOCK-DIAG-HIST-002', title: '策略误判分析', target: 'API 网关', result: 'failed', diagTime: '2026-05-31 14:15:00', reportUrl: '#' },
];

export function BlockDiagHistoryQuery() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">安全阻断诊断任务历史查询</h2>
