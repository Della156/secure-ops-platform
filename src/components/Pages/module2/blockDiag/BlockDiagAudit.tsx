...
const mockAudit: AuditItem[] = [
  { id: 'AUDIT-BLOCK-001', operator: '张三', action: '启动诊断', target: 'Web 服务集群', taskId: 'BLOCK-DIAG-001', time: '2026-06-02 09:00:00', result: 'success' },
  { id: 'AUDIT-BLOCK-002', operator: '李四', action: '查看报告', target: 'API 网关', taskId: 'BLOCK-DIAG-002', time: '2026-06-01 15:00:00', result: 'success' },
];

export function BlockDiagAudit() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">安全阻断诊断任务审计</h2>
