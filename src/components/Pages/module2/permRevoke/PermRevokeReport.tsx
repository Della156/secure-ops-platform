...
const taskData = [
  { date: '05-28', tasks: 15, success: 14, failure: 1 },
  { date: '05-29', tasks: 20, success: 18, failure: 2 },
  { date: '05-30', tasks: 10, success: 10, failure: 0 },
  { date: '05-31', tasks: 18, success: 17, failure: 1 },
  { date: '06-01', tasks: 22, success: 20, failure: 2 },
  { date: '06-02', tasks: 12, success: 11, failure: 1 },
];

export function PermRevokeReport() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">权限回收任务报告</h2>
        <p className="text-sm text-gray-400 mt-1">时间段内权限回收任务统计分析、回收报告导出</p>
      </div>
      ...
      <div className="bg-[#1E2736] border border-[#2A354D] rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-300 mb-4">权限回收任务统计趋势</h3>
