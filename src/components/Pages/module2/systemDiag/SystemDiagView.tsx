...
const mockTasks: DiagTask[] = [
  { id: 'SD-001', name: '系统故障排查', target: '服务器SRV-01', status: 'running', result: '诊断中...', checkTime: '2026-06-02 10:30:00', duration: '00:05:32', assignee: '张三' },
  { id: 'SD-002', name: '服务异常分析', target: '应用服务器APP-02', status: 'success', result: '已完成', checkTime: '2026-06-02 09:15:00', duration: '00:12:18', assignee: '李四' },
  { id: 'SD-003', name: '日志异常检测', target: '日志服务器LOG-01', status: 'failed', result: '检测到异常', checkTime: '2026-06-02 08:00:00', duration: '00:08:45', assignee: '王五' },
  { id: 'SD-004', name: '进程状态诊断', target: '数据库DB-01', status: 'pending', result: '待诊断', checkTime: '-', duration: '-', assignee: '赵六' },
  { id: 'SD-005', name: '系统资源分析', target: '监控服务器MON-01', status: 'abnormal', result: '资源使用率异常', checkTime: '2026-06-02 07:30:00', duration: '00:15:22', assignee: '钱七' },
];

export function SystemDiagView() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">系统故障诊断视图</h2>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-[#111827]">
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-400">诊断对象</th>
