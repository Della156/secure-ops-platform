...
const taskData = [
  { date: '05-28', tasks: 8, success: 7, failure: 1 },
  { date: '05-29', tasks: 12, success: 11, failure: 1 },
  { date: '05-30', tasks: 6, success: 6, failure: 0 },
  { date: '05-31', tasks: 10, success: 9, failure: 1 },
  { date: '06-01', tasks: 15, success: 14, failure: 1 },
  { date: '06-02', tasks: 8, success: 8, failure: 0 },
];

export function AuditTaskReport() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">审计任务报告</h2>
        <p className="text-sm text-gray-400 mt-1">时间段内审计任务统计分析、审计报告导出</p>
      </div>
      ...
      <div className="bg-[#1E2736] border border-[#2A354D] rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-300 mb-4">审计任务统计趋势</h3>
