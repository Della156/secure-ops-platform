...
const chartData = [
  { name: '巡检', total: 50, success: 48 },
  { name: '扫描', total: 30, success: 28 },
  { name: '备份', total: 40, success: 40 },
  { name: '升级', total: 10, success: 9 },
  { name: '维护', total: 25, success: 24 },
];
...
const mockReportData: ReportItem[] = [
  { category: '设备巡检', total: 100, success: 98, successRate: 98.0 },
  { category: '漏洞扫描', total: 50, success: 48, successRate: 96.0 },
  { category: '数据备份', total: 80, success: 80, successRate: 100.0 },
  { category: '系统升级', total: 20, success: 19, successRate: 95.0 },
];
...
export function OperationReport() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-white">运维操作报告</h2>
        <p className="text-sm text-gray-400 mt-1">运维操作的综合报告</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-[#1E2736] border border-[#2A354D] rounded-lg p-4">
          <h3 className="text-sm font-medium text-gray-300 mb-4">操作类型统计</h3>
