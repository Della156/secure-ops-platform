...
import { Search, Calendar, Download, RefreshCw, Clock, CheckCircle2, XCircle, Server } from 'lucide-react';
import { PageHeader } from '@/components/Common/PageStates';

const history = [
  { id: 'hist-001', name: 'HIDS状态检测', date: '2026-06-03', time: '08:00-08:15', status: 'success' },
  { id: 'hist-002', name: 'EPP策略同步', date: '2026-06-03', time: '07:30-07:40', status: 'success' },
  { id: 'hist-003', name: 'FIM规则更新', date: '2026-06-02', time: '14:00-14:20', status: 'success' },
  { id: 'hist-004', name: 'NTA日志分析', date: '2026-06-02', time: '10:00-10:30', status: 'failed' },
  { id: 'hist-005', name: 'HIDS状态检测', date: '2026-06-01', time: '09:00-09:15', status: 'success' },
];
...
export function HostComplianceHistory() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="主机合规管理任务历史查询" description="查询主机合规管理任务历史记录"
        actions={[
