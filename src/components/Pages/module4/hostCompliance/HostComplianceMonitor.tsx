...
const tasks = [
  { id: 'task-001', name: 'HIDS状态检测', status: 'running', progress: 85, startTime: '08:00:00', eta: '预计 5 分钟' },
  { id: 'task-002', name: 'EPP策略同步', status: 'completed', progress: 100, startTime: '07:30:00', eta: '已完成' },
  { id: 'task-003', name: 'FIM规则更新', status: 'running', progress: 45, startTime: '08:10:00', eta: '预计 15 分钟' },
  { id: 'task-004', name: 'NTA日志分析', status: 'pending', progress: 0, startTime: '-', eta: '等待执行' },
];
...
export function HostComplianceMonitor() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="主机合规管理任务状态监控" description="实时监控主机合规管理任务状态"
        actions={[
