...
import { Search, Calendar, Download, RefreshCw, Clock, User, Server, FileCheck } from 'lucide-react';
import { PageHeader } from '@/components/Common/PageStates';

const audits = [
  { id: 'audit-001', task: 'HIDS状态检测', operator: '系统', action: '检测开始', time: '2026-06-03 08:00:00', result: 'success' },
  { id: 'audit-002', task: 'HIDS状态检测', operator: '系统', action: '检测完成', time: '2026-06-03 08:15:00', result: 'success' },
  { id: 'audit-003', task: 'EPP策略同步', operator: '张三', action: '启动同步', time: '2026-06-03 07:30:00', result: 'success' },
  { id: 'audit-004', task: 'EPP策略同步', operator: '系统', action: '同步完成', time: '2026-06-03 07:40:00', result: 'success' },
  { id: 'audit-005', task: 'FIM规则更新', operator: '李四', action: '启动更新', time: '2026-06-02 14:00:00', result: 'success' },
  { id: 'audit-006', task: 'NTA日志分析', operator: '系统', action: '分析失败', time: '2026-06-02 10:30:00', result: 'failed' },
];
...
export function HostComplianceAudit() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="主机合规管理任务审计" description="审计主机合规管理任务操作记录"
        actions={[
