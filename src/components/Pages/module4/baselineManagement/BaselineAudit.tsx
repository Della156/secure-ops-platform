...
const auditLogs = [
  { id: 'AUD-001', operator: 'admin', operation: '创建扫描任务', target: 'SCAN-001', targetName: '每日基线扫描', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-002', operator: 'admin', operation: '启动扫描任务', target: 'SCAN-001', targetName: '每日基线扫描', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-003', operator: 'user1', operation: '查看扫描结果', target: 'RES-001', targetName: '操作系统基线扫描结果', time: '2026-06-03 08:15', ip: '192.168.1.101' },
  { id: 'AUD-004', operator: 'admin', operation: '创建基线版本', target: 'VER-001', targetName: '操作系统安全基线 v2.1.0', time: '2026-06-03 10:00', ip: '192.168.1.100' },
];

const operationColors: Record<string, string> = {
  '创建扫描任务': 'bg-green-500/20 text-green-400',
  '启动扫描任务': 'bg-blue-500/20 text-blue-400',
  '查看扫描结果': 'bg-gray-500/20 text-gray-400',
  '创建基线版本': 'bg-yellow-500/20 text-yellow-400',
};
...
export function BaselineAudit() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="基线管理任务审计" description="审计基线管理任务操作记录"
        actions={[
