...
const history = [
  { id: 'HIST-001', taskName: '2026年6月资产确认', taskId: 'CONF-001', status: 'completed', startTime: '2026-06-03 08:00', endTime: '2026-06-03 08:30', duration: '30分钟', confirmed: 521, total: 543 },
  { id: 'HIST-002', taskName: '数据中心资产确认', taskId: 'CONF-002', status: 'completed', startTime: '2026-06-03 09:00', endTime: '2026-06-03 09:45', duration: '45分钟', confirmed: 245, total: 250 },
  { id: 'HIST-003', taskName: '2026年5月资产确认', taskId: 'CONF-005', status: 'completed', startTime: '2026-05-01 00:00', endTime: '2026-05-01 01:30', duration: '1小时30分', confirmed: 512, total: 530 },
];

export function AssetConfirmationHistory() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产确认任务历史查询" description="查询和查看资产确认任务历史记录"
        actions={[
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111625]">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">确认/总数</th>
            ...
            <tbody className="divide-y divide-[#2A354D]">
              {filteredHistory.map(item => (
                <tr key={item.id} className="hover:bg-[#111625]/50">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-green-400 text-sm">{item.confirmed} / {item.total}</span>
                  </td>
                  <td className="px-4 py-3">
...
export default AssetConfirmationHistory;