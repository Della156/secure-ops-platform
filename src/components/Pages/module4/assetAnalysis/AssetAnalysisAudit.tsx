...
const auditLogs = [
  { id: 'AUD-001', operator: 'admin', operation: '创建分析任务', target: 'ANALY-001', targetName: '2026年6月资产分析', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-002', operator: 'admin', operation: '启动分析任务', target: 'ANALY-001', targetName: '2026年6月资产分析', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-003', operator: 'user1', operation: '查看分析结果', target: 'ANALY-002', targetName: '数据中心资产分析', time: '2026-06-03 09:45', ip: '192.168.1.101' },
  { id: 'AUD-004', operator: 'admin', operation: '应用优化建议', target: 'SUGG-001', targetName: 'db-server-01 资源优化', time: '2026-06-03 10:00', ip: '192.168.1.100' },
];

const operationColors: Record<string, string> = {
  '创建分析任务': 'bg-green-500/20 text-green-400',
  '启动分析任务': 'bg-blue-500/20 text-blue-400',
  '查看分析结果': 'bg-gray-500/20 text-gray-400',
  '应用优化建议': 'bg-yellow-500/20 text-yellow-400',
};

export function AssetAnalysisAudit() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产分析任务审计" description="审计资产分析任务操作记录"
        actions={[
...
export default AssetAnalysisAudit;