...
const tasks = [
  { id: 'ANALY-001', name: '2026年6月资产分析', type: '定时任务', status: 'completed', progress: 100, startTime: '2026-06-03 08:00', endTime: '2026-06-03 08:30', analyzedAssets: 543, findings: 23 },
  { id: 'ANALY-002', name: '数据中心资产分析', type: '手动任务', status: 'running', progress: 75, startTime: '2026-06-03 09:00', endTime: '-', analyzedAssets: 188, findings: 15 },
  { id: 'ANALY-003', name: '风险评估任务', type: '定时任务', status: 'pending', progress: 0, startTime: '-', endTime: '2026-06-03 10:00', analyzedAssets: 0, findings: 0 },
];

export function AssetAnalysisMonitor() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产分析任务状态监控" description="实时监控资产分析任务状态"
        actions={[
            ...
            <div key={task.id} className="p-4 hover:bg-[#111625]/50">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-right">
                  <div className="text-sm text-white">已分析: {task.analyzedAssets}</div>
                  <div className="text-xs text-red-400">发现问题: {task.findings}</div>
                </div>
              </div>
            </div>
          ))}
...
export default AssetAnalysisMonitor;