...
const tasks = [
  { id: 'RECON-001', name: '2026年6月资产核对', type: '定时任务', status: 'completed', progress: 100, startTime: '2026-06-03 08:00', endTime: '2026-06-03 08:30', matched: 521, total: 543 },
  { id: 'RECON-002', name: '数据中心资产核对', type: '手动任务', status: 'running', progress: 72, startTime: '2026-06-03 09:00', endTime: '-', matched: 180, total: 250 },
  { id: 'RECON-003', name: '云环境资产核对', type: '定时任务', status: 'pending', progress: 0, startTime: '-', endTime: '2026-06-03 10:00', matched: 0, total: 600 },
  { id: 'RECON-004', name: '办公区资产核对', type: '手动任务', status: 'failed', progress: 81, startTime: '2026-06-02 16:00', endTime: '-', matched: 100, total: 124 },
];

export function AssetReconciliationMonitor() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产核对任务状态监控" description="实时监控资产核对任务状态"
        actions={[
            ...
            <div key={task.id} className="p-4 hover:bg-[#111625]/50">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {task.status === 'failed' && (
                    <button className="flex items-center gap-1 px-3 py-1 bg-blue-500/20 text-blue-400 text-xs rounded-lg hover:bg-blue-500/30">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-right">
                  <div className="text-sm text-green-400">{task.matched} / {task.total}</div>
                  <div className="text-xs text-slate-400">匹配数</div>
                </div>
              </div>
            </div>
          ))}
...
export default AssetReconciliationMonitor;