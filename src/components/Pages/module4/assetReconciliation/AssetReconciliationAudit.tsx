...
const auditLogs = [
  { id: 'AUD-001', operator: 'admin', operation: '创建核对任务', target: 'RECON-001', targetName: '2026年6月资产核对', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-002', operator: 'admin', operation: '启动核对任务', target: 'RECON-001', targetName: '2026年6月资产核对', time: '2026-06-03 08:00', ip: '192.168.1.100' },
  { id: 'AUD-003', operator: 'user1', operation: '查看核对结果', target: 'RECON-002', targetName: '数据中心资产核对', time: '2026-06-03 09:45', ip: '192.168.1.101' },
  { id: 'AUD-004', operator: 'admin', operation: '批准更新', target: 'UPDATE-001', targetName: 'web-server-01 IP更新', time: '2026-06-03 08:30', ip: '192.168.1.100' },
  { id: 'AUD-005', operator: 'admin', operation: '导出报告', target: 'REPORT-001', targetName: '资产核对报告', time: '2026-06-03 09:00', ip: '192.168.1.100' },
];

const operationColors: Record<string, string> = {
  '创建核对任务': 'bg-green-500/20 text-green-400',
  '启动核对任务': 'bg-blue-500/20 text-blue-400',
  '查看核对结果': 'bg-gray-500/20 text-gray-400',
  '批准更新': 'bg-yellow-500/20 text-yellow-400',
  '导出报告': 'bg-orange-500/20 text-orange-400',
};

export function AssetReconciliationAudit() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产核对任务审计" description="审计资产核对任务操作记录"
        actions={[
...
export default AssetReconciliationAudit;