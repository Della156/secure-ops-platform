...
const history = [
  { id: 'HIST-001', taskName: '2026年6月资产核对', taskId: 'RECON-001', status: 'completed', startTime: '2026-06-03 08:00', endTime: '2026-06-03 08:30', duration: '30分钟', matched: 521, total: 543 },
  { id: 'HIST-002', taskName: '数据中心资产核对', taskId: 'RECON-002', status: 'completed', startTime: '2026-06-03 09:00', endTime: '2026-06-03 09:45', duration: '45分钟', matched: 245, total: 250 },
  { id: 'HIST-003', taskName: '办公区资产核对', taskId: 'RECON-004', status: 'failed', startTime: '2026-06-02 16:00', endTime: '2026-06-02 16:30', duration: '30分钟', matched: 100, total: 124 },
  { id: 'HIST-004', taskName: '云环境资产核对', taskId: 'RECON-003', status: 'completed', startTime: '2026-06-02 10:00', endTime: '2026-06-02 10:25', duration: '25分钟', matched: 598, total: 600 },
  { id: 'HIST-005', taskName: '2026年5月资产核对', taskId: 'RECON-005', status: 'completed', startTime: '2026-05-01 00:00', endTime: '2026-05-01 01:30', duration: '1小时30分', matched: 512, total: 530 },
];

export function AssetReconciliationHistory() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader title="资产核对任务历史查询" description="查询和查看资产核对任务历史记录"
        actions={[
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111625]">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">匹配/总数</th>
            ...
            <tbody className="divide-y divide-[#2A354D]">
              {filteredHistory.map(item => (
                <tr key={item.id} className="hover:bg-[#111625]/50">
                  ...
                  <td className="px-4 py-3">
                    <span className={`text-sm ${item.matched === item.total ? 'text-green-400' : 'text-yellow-400'}`}>
...
export default AssetReconciliationHistory;